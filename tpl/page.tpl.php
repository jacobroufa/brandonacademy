...
?>
  ...
  <?php if (!$is_front): ?><hr class="fullpage" /><?php endif; ?>

  <div id="page" class="mast"><div class="top-push"></div>
...
<!--    <?php if ($breadcrumb): ?>
  ...
  <div class="end-push"></div></div> <!-- end #page -->
